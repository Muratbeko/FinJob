      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <a data-fancybox data-ratio="2" href="https://youtu.be/tAnKXP74BHk?si=va8vc5DHvmn_GUG4" class="block__96788">
          ...
          <div class="col-lg-5 ml-auto">
            ...
            <p class="lead"><-watch free cartoon from me</p>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5 mb-lg-0 order-md-2">
            <a data-fancybox data-ratio="2" href="https://vimeo.com/317571768" class="block__96788">
              <span class="play-icon"><span class="icon-play"></span></span>
              <img src="{{asset('assets/images/sq_img_8.jpg')}}" alt="Image" class="img-fluid img-shadow">
            </a>
          </div>
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row align-items-center block__69944">
          ...
          <div class="col-md-6">
            <img src="{{asset('assets/images/person_6.jpg')}}" alt="Image" class="img-fluid mb-4 rounded">
          </div>
