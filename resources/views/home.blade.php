  ...
  <div class="owl-carousel single-carousel">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 align-self-center text-center text-lg-left">
          <blockquote>
            <p>&ldquo;Do what you can do! Fitting!&rdquo;</p>
            <p><cite> &mdash;  Sam Mical</cite></p>
          </blockquote>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 align-self-center text-center text-lg-left">
          <blockquote>
            <p>&ldquo;Find your favourite job!&rdquo;</p>
            <p><cite> &mdash; Sam Mical</cite></p>
          </blockquote>
        </div>
        <div class="col-lg-6 align-self-end text-center text-lg-right">
...
<div class="container">
  <div class="row">
    <div class="col-md-6 align-self-center text-center text-md-left mb-5 mb-md-0">
      <h2 class="text-white">Get The Mobile Apps(Not avilable, пока}</h2>
